...
const dealCards = () => {
    for (let i = 0; i < 7; i++) {
		...
		let aa=cpu2Hand.length-1
console.log('cpu2Hand[aa]')
...
const drawCard = (handGetsCard) => {
        console.log('drawCard') // TODO: remove
...
const animateDrawCard = (player) => {
    console.log('animateDrawCard') // TODO: remove
...
const showUno = (unoHand) => {
    console.log('showUno') // TODO: remove
...
//#region CPU SPECIFIC FUNCTIONS
    function determinePlayableCards() {
	     console.log('determinePlayableCards')
    ...
    function runStrategist(playable) {
        ...
        function returnPlayablesToHand() {
			     console.log('returnPlayablesToHand')
    ...
    function playCPUCard(chosenCard) {
        ...
        function checkChangeTurn() {
		    console.log('checkChangeTurn') // TODO: remove
    ...
    function chooseColorAfterWild() {
	    console.log('chooseColorAfterWild') // TODO: remove
...
const playCPU2 = () => {   
     console.log('CPU2--->CPU2--->playCPU2')

    if (!playerTurn && gameOn) {
        console.log('CPU2--->cpu beginning turn') // TODO: remove        
        ...
        // if no playable cards
        if (playable.length === 0) {
            console.log('CPU2--->CPU has no cards to play') // TODO: remove
            // draw card
            drawCard(cpu2Hand)
            // end turn
            setTimeout(() => {
                console.log('CPU2--->CPU ending turn') // TODO: remove
                playerTurn = 3
                return
            }, 500)
        }
        ...
        // if more than one playable cards
            ...
            console.log('CPU2--->cpu 2 has', playable.length, 'playable cards')
...
//#region CPU SPECIFIC FUNCTIONS
    function determinePlayableCards() {
	     console.log('CPU2--->determinePlayableCards')

        const playableCards = []

        console.log('CPU2--->last card played:') // TODO: remove
        console.log(playPile[playPile.length - 1])
        for (let i = 0; i < cpu2Hand.length; i++) {
        ...
        console.log('CPU2--->playable cards:')
        console.log(playableCards) // TODO: remove
    ...
    function runStrategist(playable) {
        let cardIndex
	     ...
	     console.log('CPU2--->runStrategist')
			
        // run strategist to determine strategy
        let strategist = Math.random()
        console.log('CPU2--->strategist:', strategist) // TODO: remove
        // if strategist > 0.5 || playerHand <= 3
        if (playPile.length > 2 && (strategist > 0.7 || playerHand.length < 3 || cpuHand.length > (playerHand.length * 2) || (playPile[playPile.length - 1].playedByPlayer === true && playPile[playPile.length - 1].drawValue > 0) || (playPile[playPile.length - 2].playedByPlayer === true && playPile[playPile.length - 1].drawValue > 0))) {
            // prioritize action/high point cards
            console.log('CPU2--->cpu2 chose high card') // TODO: remove
            let highestValue = 0
            ...
            // else prioritize color || number cards
            console.log('CPU2--->cpu2 chose low card') // TODO: remove
            let lowestValue = 14
        ...
        function returnPlayablesToHand() {
			     console.log('CPU2--->returnPlayablesToHand')
    ...
    function playCPU2Card(chosenCard) {
        console.log('CPU2--->playing card:') // TODO: remove
        console.log(chosenCard)
        ...
        console.log('CPU2--->animating CPU2 card')
        pickPlayCardSound()
        // debugger
        ...
        setTimeout(() => {
            ...
            // check if cpu played wild
            if (playPile[playPile.length - 1].color === 'any' && playPile[playPile.length - 1].drawValue === 0 && playPile[playPile.length - 1].playedByPlayer === false) {
                console.log('CPU2--->cpu2 played a wild') // TODO: remove
                chooseColorAfterWild()
            }
            ...
            if (chosenCard.drawValue > 0) {
                // alert('cpu played a +' + chosenCard.drawValue + ' card!')
                console.log('CPU2--->cpu2 played a +' + chosenCard.drawValue + ' card!') // TODO: remove
                hitWithDrawCard()
                setTimeout(() => {
                    for (let i = 0; i < chosenCard.drawValue; i++) {
                        drawCard(playerHand)
        ...
        function checkChangeTurn() {
		    console.log('CPU2--->checkChangeTurn') // TODO: remove

            if (chosenCard.changeTurn) {
                // if changeTurn, playerTurn = true
                console.log('CPU2--->cpu2 has finished its turn') // TODO: remove
				if (playerTurn==2) {
				    playerTurn==1
                    setTimeout(playCPU, cpuDelay)
				}
				    ...
				    playerTurn==3
					console.log('PLAYERTURN=3')
					return	
				}
            }
            else {
                // else cpuTurn() again
                console.log('CPU2--->cpu2 goes again') // TODO: remove
				    playerTurn==3
					console.log('CPU2 NEXT PLAYER -->PLAYERTURN=3')
					return            }
        }
    }

    function chooseColorAfterWild() {
	    console.log('CPU2--->chooseColorAfterWild') // TODO: remove

        console.log('CPU2--->cpu picking new color') // TODO: remove
        const colors = ['rgb(255, 6, 0)', 'rgb(0, 170, 69)', 'rgb(0, 150, 224)', 'rgb(255, 222, 0)']
        const colorsInHand = [0, 0, 0, 0]
...
const hitWithDrawCard = () => {
	    console.log('hitWithDrawCard') // TODO: remove
...
const playPlayerCard = (index) => {
	    console.log('playPlayerCard') // TODO: remove
...
const startGame = () => {
	    console.log('startGame') // TODO: remove
...
//#endregion
let cpuVisible = true
let cpu2Visible = false

const listenForDevMode = () => {
	    console.log('listenForDevMode') // TODO: remove
